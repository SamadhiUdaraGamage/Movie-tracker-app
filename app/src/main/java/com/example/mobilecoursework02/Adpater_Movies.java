...
public class Adpater_Movies extends RecyclerView.Adapter<Adpater_Movies.ViewHolder> {
    ...
    public Adpater_Movies(Context context, String[] movie_names,String[] movie_ids,int[] movie_fav) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.activity_row_movie, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        Log.d("myz", "Movie name "+movie_names.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            movie_name =  itemView.findViewById(R.id.title_text);

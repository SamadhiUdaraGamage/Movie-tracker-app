...
public class imdb extends AppCompatActivity {
    ...
    public void subjectload(){
        ...
        String movie_url = "https://imdb-api.com/en/API/SearchTitle/k_lhxxwc8d/Inception";
...
//                                    }
                                ...
                                Toast.makeText(imdb.this, "No Results, Go Back and try again", Toast.LENGTH_LONG).show();
                            }
                            Log.d("xyz" , "no error :");
                        } catch (JSONException e) {
                            Toast.makeText(imdb.this, "Something Wrong, Go Back and try again", Toast.LENGTH_LONG).show();
